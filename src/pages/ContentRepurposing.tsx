                          ...
                          <Card key={formatId} className="p-4">
                            ...
                            <div className="text-sm text-muted-foreground bg-muted/50 p-3 rounded whitespace-pre-wrap">
                              {isGenerating ? (
                                ...
                                inputContent ? 'Click "Repurpose Content" to generate' : 'Add content to generate'
                              )}
                            </div>
                          </Card>
                        );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Twitter threads</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />LinkedIn posts</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Instagram captions</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Facebook posts</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Newsletter sections</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Email sequences</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Subject lines</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Call-to-actions</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Key takeaways</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Bullet points</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Quotes &amp; snippets</li>
                  <li className="flex items-center"><CheckCircle className="h-4 w-4 text-green-600 mr-2" />Infographic text</li>
                </ul>
              </CardContent>
            </Card>
          </div>
